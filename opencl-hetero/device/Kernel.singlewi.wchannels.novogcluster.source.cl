...
//For two devices, I am dividing up the application like this:
//Device 0:
  //kernel_mem_rd"
...
//Device 1:
  ...
  //kernel_updates"
  //kernel_mem_wr"
//Device 0 seems to be slighly less loaded than 0. But I wanted to minimize the channel communication between devices, so 
// I had to use inputs to a SMACHE module rather than outputs from it. That meant one of the devices had to be lightly loaded
// Using 3 devices would make balancing easier
...
//DYN1-2-DYN2
channel stypeDevice    un_dyn1_2_dyn2_pre_out  __attribute__((io(   "un_dyn1_2_dyn2_pre_out")));
channel stypeDevice    vn_dyn1_2_dyn2_pre_out  __attribute__((io(   "vn_dyn1_2_dyn2_pre_out")));
channel stypeDevice     h_dyn1_2_dyn2_pre_out  __attribute__((io(    "h_dyn1_2_dyn2_pre_out")));
channel stypeDevice   eta_dyn1_2_dyn2_pre_out  __attribute__((io(  "eta_dyn1_2_dyn2_pre_out")));
channel stypeDevice  etan_dyn1_2_dyn2_pre_out  __attribute__((io( "etan_dyn1_2_dyn2_pre_out")));
channel stypeDevice   wet_dyn1_2_dyn2_pre_out  __attribute__((io(  "wet_dyn1_2_dyn2_pre_out")));
channel stypeDevice hzero_dyn1_2_dyn2_pre_out  __attribute__((io("hzero_dyn1_2_dyn2_pre_out")));

#elif (MYDEVICEID==1)

//DYN1-2-DYN2
channel stypeDevice    un_dyn1_2_dyn2_pre_in  __attribute__((io(   "un_dyn1_2_dyn2_pre_in")));
channel stypeDevice    vn_dyn1_2_dyn2_pre_in  __attribute__((io(   "vn_dyn1_2_dyn2_pre_in")));
channel stypeDevice     h_dyn1_2_dyn2_pre_in  __attribute__((io(    "h_dyn1_2_dyn2_pre_in")));
channel stypeDevice   eta_dyn1_2_dyn2_pre_in  __attribute__((io(  "eta_dyn1_2_dyn2_pre_in")));
channel stypeDevice  etan_dyn1_2_dyn2_pre_in  __attribute__((io( "etan_dyn1_2_dyn2_pre_in")));
channel stypeDevice   wet_dyn1_2_dyn2_pre_in  __attribute__((io(  "wet_dyn1_2_dyn2_pre_in")));
channel stypeDevice hzero_dyn1_2_dyn2_pre_in  __attribute__((io("hzero_dyn1_2_dyn2_pre_in")));
