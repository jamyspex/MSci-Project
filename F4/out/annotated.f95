...
subroutine read_pipe(pipe, var)
    integer :: pipe
end subroutine read_pipe

subroutine write_pipe(pipe, var)
    integer :: pipe
end subroutine write_pipe

subroutine read_pipe_int(pipe, var)
    integer :: pipe
    integer :: var
end subroutine read_pipe_int

subroutine write_pipe_int(pipe, var)
    integer :: pipe
    integer :: var
end subroutine write_pipe_int

subroutine ocl_pipe_real(pipe)
    integer :: pipe
end subroutine ocl_pipe_real
...
subroutine pipe_initialisation
    ...
    call ocl_pipe_real(dyn_1_smart_cache__dyn_1__wet_j_kp1__pipe)
    call ocl_pipe_real(dyn_1_smart_cache__dyn_1__wet_jp1_k__pipe)
    call ocl_pipe_real(dyn_1_smart_cache__dyn_1__wet_j_k__pipe)
    call ocl_pipe_real(dyn_1_wet_j_k_reader__dyn_1_smart_cache__wet_j_k__pipe)
    ...
    call ocl_pipe_real(shapiro_smart_cache__shapiro__wet_jm1_k__pipe)
    call ocl_pipe_real(shapiro_smart_cache__shapiro__wet_j_kp1__pipe)
    call ocl_pipe_real(shapiro_smart_cache__shapiro__wet_j_k__pipe)
    call ocl_pipe_real(shapiro_smart_cache__shapiro__wet_jp1_k__pipe)
    call ocl_pipe_real(shapiro_smart_cache__shapiro__wet_j_km1__pipe)
    call ocl_pipe_real(shapiro_wet_j_k_reader__shapiro_smart_cache__wet_j_k__pipe)
    ...
    call ocl_pipe_real(vernieuw__vernieuw_output_writer__wet_j_k__pipe)
...
subroutine dyn_1_wet_j_k_reader(wet)
      real, dimension(0:501,0:501) :: wet
      real :: wet_j_k
      integer :: a
      integer :: b
    do a = 0, 501, 1
...
subroutine dyn_1
    ...
    do count = 1, nloop, 1
        ...
        call read_pipe_int(dyn_1_smart_cache__dyn_1__wet_j_k__pipe, wet_j_k)
        call read_pipe_int(dyn_1_smart_cache__dyn_1__wet_j_kp1__pipe, wet_j_kp1)
        call read_pipe_int(dyn_1_smart_cache__dyn_1__wet_jp1_k__pipe, wet_jp1_k)
        j = count/502
        k = mod(count, 502)
        if ((j>=1) .and. (j<=500) .and. (k>=1) .and. (k<=500)) then
                un_j_k = 0.0
...
subroutine dyn_2(dt,dx,dy)
      ...
      real :: vn_j_k
      real :: vn_jm1_k
      !real :: vn_j_k ! FIXME this is duplicated
      ! FIXME un_j_km1 is also missing a declaration
    do count = 1, nloop, 1
...
subroutine shapiro(eps)
      ...
      integer :: wet_jp1_k
      integer :: wet_j_km1
      ! FIXME missing decalrations for transit stream variables - un_j_k, vn_j_k
    do count = 1, nloop, 1
        ...
        call read_pipe_int(shapiro_smart_cache__shapiro__wet_j_k__pipe, wet_j_k)
        call read_pipe_int(shapiro_smart_cache__shapiro__wet_j_km1__pipe, wet_j_km1)
        call read_pipe_int(shapiro_smart_cache__shapiro__wet_j_kp1__pipe, wet_j_kp1)
        call read_pipe_int(shapiro_smart_cache__shapiro__wet_jm1_k__pipe, wet_jm1_k)
        call read_pipe_int(shapiro_smart_cache__shapiro__wet_jp1_k__pipe, wet_jp1_k)
        j = count/502
        k = mod(count, 502)
        if ((j>=1) .and. (j<=500) .and. (k>=1) .and. (k<=500)) then
                if (wet_j_k==1) then
...
subroutine vernieuw(hmin)
    ...
    do count = 1, nloop, 1
        ...
        call write_pipe_int(vernieuw__vernieuw_output_writer__wet_j_k__pipe, wet_j_k)
    end do
