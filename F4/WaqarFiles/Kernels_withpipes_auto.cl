...
__kernel __attribute__((reqd_work_group_size(1,1,1))) void dyn_0_eta_j_k_reader(__global float *eta) {
    ...
    for (a = 0;a <= 501;a += 1) {
        for (b = 0;b <= 501;b += 1) {
                                ...
                                write_pipe_block(dyn_0_eta_j_k_reader__dyn_0_smart_cache__eta_j_k__pipe,&eta_j_k);
        }
    }
    }
...
#pragma unroll
        ...
        if (count<driverloopsize) {
                                read_pipe_block(dyn_0_eta_j_k_reader__dyn_0_smart_cache__eta_j_k__pipe,&eta_read_in);
                                eta_buffer[F1D2C(1 , 503)] = eta_read_in;
        }
        if (compindex>=0) {
                                eta_j_k = *eta_buffer;
                                write_pipe_block(dyn_0_smart_cache__dyn_0__eta_j_k__pipe,&eta_j_k);
                                eta_j_kp1 = eta_buffer[F1D2C(1 , 503)];
                                write_pipe_block(dyn_0_smart_cache__dyn_0__eta_j_kp1__pipe,&eta_j_kp1);
                                eta_jp1_k = eta_buffer[F1D2C(1 , 2)];
                                write_pipe_block(dyn_0_smart_cache__dyn_0__eta_jp1_k__pipe,&eta_jp1_k);
        }
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void dyn_0(float dt,float dx,float dy,float g) {
      ...
      int k;
    for (count = 1;count <= nloop;count += 1) {
                read_pipe_block(dyn_0_smart_cache__dyn_0__eta_j_k__pipe,&eta_j_k);
                read_pipe_block(dyn_0_smart_cache__dyn_0__eta_j_kp1__pipe,&eta_j_kp1);
                read_pipe_block(dyn_0_smart_cache__dyn_0__eta_jp1_k__pipe,&eta_jp1_k);
                j = count*1.0/502;
                k = count%502;
        if ((j>=1)&&j<=500&&k>=1&&k<=500) {
                ...
                write_pipe_block(dyn_0__dyn_1__du_j_k__pipe,&du_j_k);
                write_pipe_block(dyn_0__dyn_1__dv_j_k__pipe,&dv_j_k);
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void dyn_1_wet_j_k_reader(__global float *wet) {
    ...
    for (a = 0;a <= 501;a += 1) {
        for (b = 0;b <= 501;b += 1) {
                                ...
                                write_pipe_block(dyn_1_wet_j_k_reader__dyn_1_smart_cache__wet_j_k__pipe,&wet_j_k);
        }
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void dyn_1_u_j_k_reader(__global float *u) {
    ...
    for (a = 0;a <= 501;a += 1) {
        for (b = 0;b <= 501;b += 1) {
                                ...
                                write_pipe_block(dyn_1_u_j_k_reader__dyn_1__u_j_k__pipe,&u_j_k);
        }
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void dyn_1_v_j_k_reader(__global float *v) {
    ...
    for (a = 0;a <= 501;a += 1) {
        for (b = 0;b <= 501;b += 1) {
                                ...
                                write_pipe_block(dyn_1_v_j_k_reader__dyn_1__v_j_k__pipe,&v_j_k);
        }
    }
    }
...
#pragma unroll
        ...
        if (count<driverloopsize) {
                                read_pipe_block(dyn_1_wet_j_k_reader__dyn_1_smart_cache__wet_j_k__pipe,&wet_read_in);
                                wet_buffer[F1D2C(1 , 503)] = wet_read_in;
        }
        if (compindex>=0) {
                                wet_j_k = *wet_buffer;
                                write_pipe_block(dyn_1_smart_cache__dyn_1__wet_j_k__pipe,&wet_j_k);
                                wet_j_kp1 = wet_buffer[F1D2C(1 , 503)];
                                write_pipe_block(dyn_1_smart_cache__dyn_1__wet_j_kp1__pipe,&wet_j_kp1);
                                wet_jp1_k = wet_buffer[F1D2C(1 , 2)];
                                write_pipe_block(dyn_1_smart_cache__dyn_1__wet_jp1_k__pipe,&wet_jp1_k);
        }
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void dyn_1() {
      ...
      float wet_j_k;
    for (count = 1;count <= nloop;count += 1) {
                read_pipe_block(dyn_0__dyn_1__du_j_k__pipe,&du_j_k);
                read_pipe_block(dyn_0__dyn_1__dv_j_k__pipe,&dv_j_k);
                read_pipe_block(dyn_1_u_j_k_reader__dyn_1__u_j_k__pipe,&u_j_k);
                read_pipe_block(dyn_1_v_j_k_reader__dyn_1__v_j_k__pipe,&v_j_k);
                read_pipe_block(dyn_1_smart_cache__dyn_1__wet_j_k__pipe,&wet_j_k);
                read_pipe_block(dyn_1_smart_cache__dyn_1__wet_j_kp1__pipe,&wet_j_kp1);
                read_pipe_block(dyn_1_smart_cache__dyn_1__wet_jp1_k__pipe,&wet_jp1_k);
                j = count*1.0/502;
                k = count%502;
        if ((j>=1)&&j<=500&&k>=1&&k<=500) {
                                un_j_k = 0.0;
                ...
                write_pipe_block(dyn_1__dyn_2_smart_cache__un_j_k__pipe,&un_j_k);
                write_pipe_block(dyn_1__dyn_2_smart_cache__vn_j_k__pipe,&vn_j_k);
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void dyn_2_h_j_k_reader(__global float *h) {
    ...
    for (a = 0;a <= 501;a += 1) {
        for (b = 0;b <= 501;b += 1) {
                                ...
                                write_pipe_block(dyn_2_h_j_k_reader__dyn_2_smart_cache__h_j_k__pipe,&h_j_k);
        }
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void dyn_2_eta_j_k_reader(__global float *eta) {
    ...
    for (a = 0;a <= 501;a += 1) {
        for (b = 0;b <= 501;b += 1) {
                                eta_j_k = eta[F2D2C(((501 - 0 )+1) , 0,0 , a,b)];
                                write_pipe_block(dyn_2_eta_j_k_reader__dyn_2__eta_j_k__pipe,&eta_j_k);
        }
    }
    }
...
#pragma unroll
        ...
        if (count<driverloopsize) {
                                read_pipe_block(dyn_2_h_j_k_reader__dyn_2_smart_cache__h_j_k__pipe,&h_read_in);
                                h_buffer[F1D2C(1 , 1005)] = h_read_in;
                                read_pipe_block(dyn_1__dyn_2_smart_cache__un_j_k__pipe,&un_read_in);
                                un_buffer[F1D2C(1 , 1005)] = un_read_in;
                                read_pipe_block(dyn_1__dyn_2_smart_cache__vn_j_k__pipe,&vn_read_in);
                                vn_buffer[F1D2C(1 , 1005)] = vn_read_in;
        }
        if (compindex>=0) {
                                h_j_k = h_buffer[F1D2C(1 , 503)];
                                write_pipe_block(dyn_2_smart_cache__dyn_2__h_j_k__pipe,&h_j_k);
                                h_j_km1 = *h_buffer;
                                write_pipe_block(dyn_2_smart_cache__dyn_2__h_j_km1__pipe,&h_j_km1);
                                h_j_kp1 = h_buffer[F1D2C(1 , 1005)];
                                write_pipe_block(dyn_2_smart_cache__dyn_2__h_j_kp1__pipe,&h_j_kp1);
                                h_jm1_k = h_buffer[F1D2C(1 , 502)];
                                write_pipe_block(dyn_2_smart_cache__dyn_2__h_jm1_k__pipe,&h_jm1_k);
                                h_jp1_k = h_buffer[F1D2C(1 , 504)];
                                write_pipe_block(dyn_2_smart_cache__dyn_2__h_jp1_k__pipe,&h_jp1_k);
                                un_j_k = un_buffer[F1D2C(1 , 1005)];
                                write_pipe_block(dyn_2_smart_cache__dyn_2__un_j_k__pipe,&un_j_k);
                                un_j_km1 = un_buffer[F1D2C(1 , 503)];
                                write_pipe_block(dyn_2_smart_cache__dyn_2__un_j_km1__pipe,&un_j_km1);
                                vn_j_k = vn_buffer[F1D2C(1 , 1005)];
                                write_pipe_block(dyn_2_smart_cache__dyn_2__vn_j_k__pipe,&vn_j_k);
                                vn_jm1_k = vn_buffer[F1D2C(1 , 1004)];
                                write_pipe_block(dyn_2_smart_cache__dyn_2__vn_jm1_k__pipe,&vn_jm1_k);
        }
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void dyn_2(float dt,float dx,float dy) {
      ...
      float vn_jm1_k;
    for (count = 1;count <= nloop;count += 1) {
                read_pipe_block(dyn_2_eta_j_k_reader__dyn_2__eta_j_k__pipe,&eta_j_k);
                read_pipe_block(dyn_2_smart_cache__dyn_2__h_j_k__pipe,&h_j_k);
                read_pipe_block(dyn_2_smart_cache__dyn_2__h_j_km1__pipe,&h_j_km1);
                read_pipe_block(dyn_2_smart_cache__dyn_2__h_j_kp1__pipe,&h_j_kp1);
                read_pipe_block(dyn_2_smart_cache__dyn_2__h_jm1_k__pipe,&h_jm1_k);
                read_pipe_block(dyn_2_smart_cache__dyn_2__h_jp1_k__pipe,&h_jp1_k);
                read_pipe_block(dyn_2_smart_cache__dyn_2__un_j_k__pipe,&un_j_k);
                read_pipe_block(dyn_2_smart_cache__dyn_2__un_j_km1__pipe,&un_j_km1);
                read_pipe_block(dyn_2_smart_cache__dyn_2__vn_j_k__pipe,&vn_j_k);
                read_pipe_block(dyn_2_smart_cache__dyn_2__vn_jm1_k__pipe,&vn_jm1_k);
                j = count*1.0/502;
                k = count%502;
        if ((j>=1)&&j<=500&&k>=1&&k<=500) {
                ...
                write_pipe_block(dyn_2__shapiro_smart_cache__etan_j_k__pipe,&etan_j_k);
                write_pipe_block(dyn_2__shapiro_smart_cache__un_j_k__pipe,&un_j_k);
                write_pipe_block(dyn_2__shapiro_smart_cache__vn_j_k__pipe,&vn_j_k);
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void shapiro_wet_j_k_reader(__global float *wet) {
    ...
    for (a = 0;a <= 501;a += 1) {
        for (b = 0;b <= 501;b += 1) {
                                wet_j_k = wet[F2D2C(((501 - 0 )+1) , 0,0 , a,b)];
                                write_pipe_block(shapiro_wet_j_k_reader__shapiro_smart_cache__wet_j_k__pipe,&wet_j_k);
        }
    }
    }
...
#pragma unroll
        ...
        if (count<driverloopsize) {
                                read_pipe_block(dyn_2__shapiro_smart_cache__etan_j_k__pipe,&etan_read_in);
                                etan_buffer[F1D2C(1 , 1005)] = etan_read_in;
                                read_pipe_block(dyn_2__shapiro_smart_cache__un_j_k__pipe,&un_read_in);
                                un_buffer[F1D2C(1 , 1005)] = un_read_in;
                                read_pipe_block(dyn_2__shapiro_smart_cache__vn_j_k__pipe,&vn_read_in);
                                vn_buffer[F1D2C(1 , 1005)] = vn_read_in;
                                read_pipe_block(shapiro_wet_j_k_reader__shapiro_smart_cache__wet_j_k__pipe,&wet_read_in);
                                wet_buffer[F1D2C(1 , 1005)] = wet_read_in;
        }
        if (compindex>=0) {
                                etan_j_k = etan_buffer[F1D2C(1 , 503)];
                                write_pipe_block(shapiro_smart_cache__shapiro__etan_j_k__pipe,&etan_j_k);
                                etan_j_km1 = *etan_buffer;
                                write_pipe_block(shapiro_smart_cache__shapiro__etan_j_km1__pipe,&etan_j_km1);
                                etan_j_kp1 = etan_buffer[F1D2C(1 , 1005)];
                                write_pipe_block(shapiro_smart_cache__shapiro__etan_j_kp1__pipe,&etan_j_kp1);
                                etan_jm1_k = etan_buffer[F1D2C(1 , 502)];
                                write_pipe_block(shapiro_smart_cache__shapiro__etan_jm1_k__pipe,&etan_jm1_k);
                                etan_jp1_k = etan_buffer[F1D2C(1 , 504)];
                                write_pipe_block(shapiro_smart_cache__shapiro__etan_jp1_k__pipe,&etan_jp1_k);
                                un_j_k = un_buffer[F1D2C(1 , 503)];
                                write_pipe_block(shapiro_smart_cache__shapiro__un_j_k__pipe,&un_j_k);
                                vn_j_k = vn_buffer[F1D2C(1 , 503)];
                                write_pipe_block(shapiro_smart_cache__shapiro__vn_j_k__pipe,&vn_j_k);
                                wet_j_k = wet_buffer[F1D2C(1 , 503)];
                                write_pipe_block(shapiro_smart_cache__shapiro__wet_j_k__pipe,&wet_j_k);
                                wet_j_km1 = *wet_buffer;
                                write_pipe_block(shapiro_smart_cache__shapiro__wet_j_km1__pipe,&wet_j_km1);
                                wet_j_kp1 = wet_buffer[F1D2C(1 , 1005)];
                                write_pipe_block(shapiro_smart_cache__shapiro__wet_j_kp1__pipe,&wet_j_kp1);
                                wet_jm1_k = wet_buffer[F1D2C(1 , 502)];
                                write_pipe_block(shapiro_smart_cache__shapiro__wet_jm1_k__pipe,&wet_jm1_k);
                                wet_jp1_k = wet_buffer[F1D2C(1 , 504)];
                                write_pipe_block(shapiro_smart_cache__shapiro__wet_jp1_k__pipe,&wet_jp1_k);
        }
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void shapiro(float eps) {
      ...
      float wet_j_km1;
    for (count = 1;count <= nloop;count += 1) {
                read_pipe_block(shapiro_smart_cache__shapiro__etan_j_k__pipe,&etan_j_k);
                read_pipe_block(shapiro_smart_cache__shapiro__etan_j_km1__pipe,&etan_j_km1);
                read_pipe_block(shapiro_smart_cache__shapiro__etan_j_kp1__pipe,&etan_j_kp1);
                read_pipe_block(shapiro_smart_cache__shapiro__etan_jm1_k__pipe,&etan_jm1_k);
                read_pipe_block(shapiro_smart_cache__shapiro__etan_jp1_k__pipe,&etan_jp1_k);
                read_pipe_block(shapiro_smart_cache__shapiro__un_j_k__pipe,&un_j_k);
                read_pipe_block(shapiro_smart_cache__shapiro__vn_j_k__pipe,&vn_j_k);
                read_pipe_block(shapiro_smart_cache__shapiro__wet_j_k__pipe,&wet_j_k);
                read_pipe_block(shapiro_smart_cache__shapiro__wet_j_km1__pipe,&wet_j_km1);
                read_pipe_block(shapiro_smart_cache__shapiro__wet_j_kp1__pipe,&wet_j_kp1);
                read_pipe_block(shapiro_smart_cache__shapiro__wet_jm1_k__pipe,&wet_jm1_k);
                read_pipe_block(shapiro_smart_cache__shapiro__wet_jp1_k__pipe,&wet_jp1_k);
                j = count*1.0/502;
                k = count%502;
        if ((j>=1)&&j<=500&&k>=1&&k<=500) {
                if (wet_j_k==1) {
                ...
                write_pipe_block(shapiro__vernieuw__eta_j_k__pipe,&eta_j_k);
                write_pipe_block(shapiro__vernieuw__un_j_k__pipe,&un_j_k);
                write_pipe_block(shapiro__vernieuw__vn_j_k__pipe,&vn_j_k);
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void vernieuw_h_j_k_reader(__global float *h) {
    ...
    for (a = 0;a <= 501;a += 1) {
        for (b = 0;b <= 501;b += 1) {
                                h_j_k = h[F2D2C(((501 - 0 )+1) , 0,0 , a,b)];
                                write_pipe_block(vernieuw_h_j_k_reader__vernieuw__h_j_k__pipe,&h_j_k);
        }
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void vernieuw_hzero_j_k_reader(__global float *hzero) {
    ...
    for (a = 0;a <= 501;a += 1) {
        for (b = 0;b <= 501;b += 1) {
                                ...
                                write_pipe_block(vernieuw_hzero_j_k_reader__vernieuw__hzero_j_k__pipe,&hzero_j_k);
        }
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void vernieuw(float hmin) {
      ...
      float wet_j_k;
    for (count = 1;count <= nloop;count += 1) {
                read_pipe_block(shapiro__vernieuw__eta_j_k__pipe,&eta_j_k);
                read_pipe_block(vernieuw_h_j_k_reader__vernieuw__h_j_k__pipe,&h_j_k);
                read_pipe_block(vernieuw_hzero_j_k_reader__vernieuw__hzero_j_k__pipe,&hzero_j_k);
                read_pipe_block(shapiro__vernieuw__un_j_k__pipe,&un_j_k);
                read_pipe_block(shapiro__vernieuw__vn_j_k__pipe,&vn_j_k);
                j = count*1.0/502;
                k = count%502;
        ...
        if (h_j_k<hmin) {
                ...
                u_j_k = un_j_k;
                v_j_k = vn_j_k;
                write_pipe_block(vernieuw__vernieuw_output_writer__h_j_k__pipe,&h_j_k);
                write_pipe_block(vernieuw__vernieuw_output_writer__u_j_k__pipe,&u_j_k);
                write_pipe_block(vernieuw__vernieuw_output_writer__v_j_k__pipe,&v_j_k);
                write_pipe_block(vernieuw__vernieuw_output_writer__wet_j_k__pipe,&wet_j_k);
    }
    }
__kernel __attribute__((reqd_work_group_size(1,1,1))) void vernieuw_output_writer(__global float *h,__global float *u,__global float *v,__global float *wet) {
    ...
    for (a = 0;a <= 501;a += 1) {
        for (b = 0;b <= 501;b += 1) {
                                read_pipe_block(vernieuw__vernieuw_output_writer__h_j_k__pipe,&h_j_k_read_in);
                                h[F2D2C(((501 - 0 )+1) , 0,0 , a,b)] = h_j_k_read_in;
                                read_pipe_block(vernieuw__vernieuw_output_writer__u_j_k__pipe,&u_j_k_read_in);
                                u[F2D2C(((501 - 0 )+1) , 0,0 , a,b)] = u_j_k_read_in;
                                read_pipe_block(vernieuw__vernieuw_output_writer__v_j_k__pipe,&v_j_k_read_in);
                                v[F2D2C(((501 - 0 )+1) , 0,0 , a,b)] = v_j_k_read_in;
                                read_pipe_block(vernieuw__vernieuw_output_writer__wet_j_k__pipe,&wet_j_k_read_in);
