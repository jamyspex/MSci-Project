...
synthesiseKernels
    synthesiseOpenCLMap
-}
import           MiniPP                  (miniPPD, miniPPF, showSubName)
...
import           Platform
import           SubroutineTable         (ArgumentTranslation, SubRec (..),
                                          SubroutineArgumentTranslationMap,
                                          SubroutineTable (..),
                                          emptyArgumentTranslation,
                                          extractProgUnitName,
                                          extractSubroutines,
...
produceCode_fortran prog tabs originalLines codeSeg = case codeSeg of
                        ...
                        _ ->     case anyChildGenerated codeSeg || isGenerated codeSeg of
                                    ...
                                    False ->  ("CODE EXTRACTED FROM SOURCE FILE DIRECTLY\n" ++ extractOriginalCode originalLines (srcSpan codeSeg) ++ "----------------------------------")
