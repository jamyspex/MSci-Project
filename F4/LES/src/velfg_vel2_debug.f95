...
!5
      ...
      if (j==jp) then
          nou5_1 = ( v(i,1,k)+v(i,2,k))/2.
          diu5_1 = (-v(i,1,k)+v(i,2,k))/dy1(j)
          cov5_jp1 = nou5_1*diu5_1
      end if  
...
!8
      ...
      if (j==jp) then
        nou8_1 = (dzn(k+1)*v(i,0,k)+dzn(k)*v(i,0,k+1)) /(dzn(k)+dzn(k+1))
        diu8_1 = 2.*(-w(i,0,k)+w(i,1,k))/(dy1(0)+dy1(1))
        cov8_jp1 = nou8_1*diu8_1
      end if
